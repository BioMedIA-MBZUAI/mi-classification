...
for fold in range(1,6):
    ...
    train_dataset = HMC(split='train', fold=fold, seg=seg)
    test_dataset = HMC(split='test', fold=fold, seg=seg)
    ...
    logger = pl.loggers.WandbLogger(
        project='HMC', name=f'a2c_{lr}_net_{net}_bs_{tbs}_network_{net}_fold_{fold}')
